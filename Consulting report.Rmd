...
dis_plot <- function(data, title, xaxis_title, yaxis_title, zaxis_title) {
  filtered_data <- filter(data, MFI520 < quantile(data$MFI520, 0.95) & dist > quantile(data$dist, 0.05))
   filtered_data$MFI520 <- log(filtered_data$MFI520)
    filtered_data$MFI570 <- log(filtered_data$MFI570)
     filtered_data$MFI690 <- log(filtered_data$MFI690)
